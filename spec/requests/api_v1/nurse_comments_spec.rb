...
RSpec.resource 'Nurse Comments', type: :api do
  ...
  get '/v1/nurses/:nurse_id/comments' do
    let(:thread) { create(:thread, subject: nurse) }
  ...
  post '/v1/nurses/:nurse_id/comments' do
    ...
    context 'creating a top-level comment' do
      context 'with a message' do
        let(:message) { 'Not sure what this nurse means.' }
